...
function App() {
  ...
  function fetchBySearch(anime){
    setValueSearch(anime)
  ...
  return (
    ...
    <div className="App">
      <input type='text' value={valueSearch} onChange={(event) => fetchBySearch(event.target.value)}></input>
      <button onClick={() => fetchBySearch()} >submit</button>
      <Routes>
