...
function App() {
  ...
  function removeFromFavourites(anime){
    setFavourites(favourites.filter(favourite => favourite.mal_id !== anime.mal_id))
      ...
      <div className="App">
        ...
        <div className="main">
          ...
          <Routes>
            ...
            <Route
              path="/favourites"
              element={<Favourites removeFromFavourites={removeFromFavourites} favourites={favourites}></Favourites>}
            ></Route>
            <Route
              path="/anime"
            ...
            <Route
              path=":id/:id"
              element={<AnimeInfo favourites={favourites} sendToFavourites={sendToFavourites} animes={animes}></AnimeInfo>}
            ></Route>
