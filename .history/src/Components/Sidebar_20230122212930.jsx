...
function Sidebar({ favourites, genres }) {
  const [genreToggle, setGenreToggle] = useState(undefined);
  function toggleGenre() {
    genreToggle === undefined ? setGenreToggle(true) : setGenreToggle(undefined);
  }
      ...
      <div className="sidebar">
        ...
        <ul className="sidebar__list">
          ...
          >
            ...
            {!genreToggle === undefined && (
              <li className={`${genreToggle}` || "genres"}>
