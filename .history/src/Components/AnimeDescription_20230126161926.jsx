    ...
    <>
      ...
      {anime.theme && (
        <div className="Description__themes">
          ...
          <p> <strong>Episode No.</strong> :{anime.episodes || '?'}</p>
          <p> <strong>Air Date</strong> :{anime.aired.string} </p>
          <p> <strong>Anime Status</strong> :{anime.status}</p>
          <p> <strong>Anime Type</strong>:{anime.type}</p>
          <p> <strong>Duration</strong>:{anime.duration}</p>
          <p> <strong>Anime Source</strong>:{anime.source}</p>
